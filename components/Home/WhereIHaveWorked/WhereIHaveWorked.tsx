...
import AzureInnovations from './Descriptions/AzureInnovations';
...
import Frizhub from './Descriptions/Frizhub';
import PureLogics from './Descriptions/PureLogics';
...
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      ...
      case 'PureLogics':
        return <PureLogics />;
      case 'AzureInnovations':
        return <AzureInnovations />;
    }
  };

  const [DescriptionJob, setDescriptionJob] = React.useState('Frizhub');
...
const CompaniesBar = (props) => {
  ...
  const [companyNameBackgroundColorGreen, setCompanyNameBackgroundColorGreen] =
    React.useState<boolean[]>([true, false, false]);
  ...
  return (
    ...
    >
      <div
        className='hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[120px] translate-y-1 md:w-0.5  
      ...
      <div className='flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 '>
        <div className='flex flex-row md:flex-col'>
          ...
          <CompanyButton
            ...
            CompanyName='AzureInnovations'
            BarPosition={80}
            BarAvobePosition={257}
            DescriptionJob='AzureInnovations'
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              true,
